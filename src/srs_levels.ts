...
(function () {
    ...
    for(let item of document.querySelectorAll(".srs-progress li")) {
        ...
        const node = template.cloneNode() as HTMLDivElement;
        item.append(node);
 ...
 */
function prepare_srs_levels_settings_dialog(update: Function): WKOFDialog {
...
enum SRSIndividualStage {
    LOCKED = -1, LESSON = 0, APPRENTICE_1 = 1, APPRENTICE_2 = 2, APPRENTICE_3 = 3, APPRENTICE_4 = 4,
